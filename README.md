...
A compact and interactive real-time radar interface for object detection and visualization.
This repository showcases a radar-style detection system that utilizes Python, Arduino, and an ultrasonic sensor to identify and visually represent objects within a certain range. Here, you'll find everything you need to get started—from setting up the hardware to running the radar interface using OpenCV.
...
2. Clone the repo:
   git clone https://github.com/25Anurag/Radar_System.git
3. Navigate to the project directory:
   cd Radar-System-Python-Arduino
4. Check the Port before running the code and edit the COM in the line #35.
5. Run the Python script using the following command:
   python Radar_Graph_File.py
6. The radar system interface will open, displaying the scan area and detected objects in real-time using OpenCV.
7. Adjust the scanning range and rotation speed as desired by modifying the corresponding variables in the Python script.
8. Press Ctrl+C in the terminal or command prompt to stop the program.
# Data Logging
